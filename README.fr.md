...
- **`JusantKit`**, la bibliothèque : analyse harmonique et prédiction.
- **`jusant`**, la CLI.
- **Une app macOS avec son widget** (`App/JusantApp`) couvrant 13 ports : courbe du jour, pleines et basses mers, coefficients.
