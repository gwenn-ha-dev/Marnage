...
- **`MarnageKit`**, the library: harmonic analysis and prediction.
- **`marnage`**, the CLI.
- **A macOS app with its widget** (`App/Marnage`) covering 13 ports: day curve, high and low waters, coefficients.
...
The *marnage* is the tidal range — the vertical distance between high and low
water. It is the quantity this engine computes, so it is what the project is called.
